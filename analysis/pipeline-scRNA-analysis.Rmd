...
(1) <800 unique molecular identifiers (UMIs);
(2) <200 genes; 
...
Second, we identified ‘anchors’ between individual datasetswith the FindIntegrationAnchors function and inputted these anchors into the
